About catlearn-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/catlearn-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/SUNCAT-Center/CatLearn

Documentation: http://catlearn.readthedocs.io/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6550&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/catlearn-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `catlearn` can be installed with `conda`:
...
```
mamba install catlearn
```

It is possible to list all of the versions of `catlearn` available on your platform with `conda`:
...
```
mamba search catlearn --channel conda-forge
```
...
mamba repoquery search catlearn --channel conda-forge

# List packages depending on `catlearn`:
mamba repoquery whoneeds catlearn --channel conda-forge

# List dependencies of `catlearn`:
mamba repoquery depends catlearn --channel conda-forge
```
